...
import { ChevronLeft, Check, Search, Star, Store, CreditCard, X, Plus, Filter, SortAsc, SortDesc, TrendingUp, Users, BarChart3, RefreshCw, Sparkles } from 'lucide-react';
...
const PreferenceDetailScreen = () => {
  ...
  // Fetch available items with counts from database
